...
const LoginScreen = (props) => {
    const disable = () => {
        return (
            props.obj.isEmailValid !== true ||
            props.obj.isPasswordValid !== true
        );
    };
    return (
        <SafeAreaView style={[Layout.viewHeight, Common.bgWhite]}>
            ...
            <View style={login.container}>
                ...
                <TextInput
                    ...
                    onChangeText={(text) =>
                        props.setLoginForm('password', text)
                    }
                />
                <View style={[Common.mb20]}>
                    <Text
                ...
                <TouchableOpacity
                    ...
                    <View
                        ...
                        <Text style={[Common.textColorWhite, Common.fs14]}>
                            Sign In
                        </Text>
                    </View>
                </TouchableOpacity>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        setLoginForm: (...params) =>
            dispatch({ type: 'LOGIN_FORM', ...params }),
    };
};
