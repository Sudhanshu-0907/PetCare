                    ...
                    <View style={addWeight.container}>
                        ...
                        <View
                            ...
                            <View>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(text) =>
                                        props.setWeightForm('weightKg', text)
                                    }
                            ...
                            <Text style={addWeight.displayText}>
                                {`${props.obj.weightKg} kg ${
                                    props.obj.weightGrams > 0
                                        ? props.obj.weightGrams.toString() +
                                          'grams'
                                        : ''
                                }`}
                            </Text>
                        ...
                        <View style={[Layout.row]}>
                            <Button
                                ...
                                onPress={() =>
                                    props.setWeightForm('showDatePicker', true)
                                }
                                mode="outlined">
                                {moment(props.obj.dateOfWeight).format(
                                    'DD MMM YYYY h:mm a',
                                )}
                            </Button>
                        </View>
                        ...
                        <View>
                            <TextInput
                                ...
                                onChangeText={(text) =>
                                    props.setWeightForm('notes', text)
                                }
                                multiline
                                // numberOfLines={2}
